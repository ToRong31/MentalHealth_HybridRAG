@echo off
REM Mental Health Chatbot - Startup Script for Windows

echo 🚀 Starting Mental Health Chatbot...
echo.

REM Check if backend/src/.env exists
if not exist backend\src\.env (
...
findstr /C:"GEMINI_API_KEY=your_gemini_api_key_here" backend\src\.env >nul
if %errorlevel% equ 0 (
