...
import { Heart, BookOpen, Brain, Coffee } from 'lucide-react';
  ...
  return (
    <div className="h-full flex items-center justify-center p-8">
      <div className="max-w-3xl w-full text-center">
        ...
        <Button
          onClick={onNewChat}
          className="h-14 px-10 bg-gradient-to-r from-primary to-accent hover:shadow-xl hover:shadow-primary/30 text-primary-foreground rounded-2xl transition-all duration-300 mb-14 font-semibold text-base hover:scale-105"
        >
