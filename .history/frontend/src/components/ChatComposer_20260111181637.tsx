        ...
        <div className="flex items-end gap-3">
          ...
          <div className="flex-1 relative">
            <Textarea
              ...
              disabled={disabled}
              className="min-h-[44px] max-h-[120px] resize-none rounded-2xl border-2 border-border bg-input-background px-4 py-2.5 pr-12 focus:border-primary focus:ring-0 transition-all duration-200 shadow-sm"
              rows={1}
            />
          </div>
