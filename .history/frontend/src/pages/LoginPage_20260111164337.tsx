  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-3/5 relative overflow-hidden bg-gradient-to-br from-emerald-50 via-teal-50/30 to-green-50">
        ...
        <div className="absolute top-20 right-20 w-96 h-96 rounded-full blur-3xl" style={{ background: 'linear-gradient(to bottom right, rgba(6, 182, 212, 0.2), rgba(34, 211, 238, 0.2))' }}></div>
