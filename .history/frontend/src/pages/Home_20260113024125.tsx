...
const Home: React.FC = () => {
  ...
  const handleSendMessage = async (message?: string) => {
    ...
    try {
      ...
      // Use current time for bot message (consistent with user message)
      // This ensures both messages have similar timestamps
            ...
            <div className="max-w-4xl mx-auto px-6 py-8">
              ...
              {isTyping && (
                <div className="flex gap-4 mb-6">
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-slate-100 to-slate-50 border border-border flex items-center justify-center shrink-0">
