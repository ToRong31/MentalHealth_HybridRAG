# Kế Hoạch Cải Thiện Chẩn Đoán OCD & Rối Loạn Cưỡng Chế
...
### **Case Study: OCD không được phát hiện**

**Triệu chứng user mô tả:**
- Kiểm tra đi kiểm tra lại nhiều lần (cưỡng chế)
- Ý nghĩ xâm nhập: "lỡ mình sơ suất gây nguy hiểm" (ám ảnh)
- Khó chịu nếu không làm (cảm giác bị thôi thúc)
- Có chuyển việc/stress gần đây

**LLM đã làm gì:**
- ✅ Thu thập triệu chứng cơ bản
- ❌ Kết luận quá sớm: "Đây là stress bình thường"
- ❌ Không phân biệt "lo âu thường" vs "ám ảnh-cưỡng chế"
- ❌ Không hỏi câu "then chốt" để xác định OCD

**Hệ quả:**
- **Premature closure**: Route về `normal_stress` → bỏ qua diagnostic flow
- User không nhận được đánh giá chính xác về OCD
