...
async def load_prompts_async(filename: str = None) -> Union[Dict[str, Any], Dict[str, str]]:
    """
    Async version: Load prompts from YAML files
    ...
    def _load_file(filepath):
        """Blocking file read wrapped for async"""
    ...
    if filename:
        ...
        data = await asyncio.to_thread(_load_file, filepath)
