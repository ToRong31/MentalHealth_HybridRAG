...
"""
import osimport asyncioimport yaml
...
async def load_prompts(filename: str = None) -> Union[Dict[str, Any], Dict[str, str]]:
    """Async wrapper for loading prompts to avoid blocking I/O.
