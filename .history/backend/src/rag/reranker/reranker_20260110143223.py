...
class CohereReranker:
    ...
    async def rerank_anchors(
        ...
        """
        Rerank candidates using Cohere Rerank API (async)
        ...
        try:
            ...
            # Call Cohere Rerank API in executor to avoid blocking
    ...
    async def rerank_chunks(
        ...
        """
        Rerank text chunks using Cohere Rerank API (async)
        ...
        try:
            ...
            # Call Cohere Rerank API in executor to avoid blocking event loop
            loop = asyncio.get_event_loop()
            response = await loop.run_in_executor(
                None,
                lambda: self.client.rerank(
