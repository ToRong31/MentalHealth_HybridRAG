...
# Helper function to generate fallback questions from missing slots
def generate_questions_from_missing_slots(missing_slots: List[str], max_questions: int = 3) -> List[str]:
    """
    Generate natural follow-up questions from missing REQUIRED slots.
    Used as fallback when LLM fails to generate questions.
