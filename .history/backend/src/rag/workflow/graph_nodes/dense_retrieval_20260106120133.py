...
# Initialize DenseRetrieval instance
...
async def dense_retrieval_node(state: KGState) -> KGState:
    ...
    # Get retrieval instance and retrieve
    retrieval = get_dense_retrieval()
    results = retrieval.retrieve(query_for_retrieval, top_k=2)
