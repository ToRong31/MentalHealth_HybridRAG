...
class CheckpointerManager:
    ...
    def _initialize_checkpointer(self):
        ...
        try:
            ...
            # NOTE: AsyncPostgresSaver.setup() is an async coroutine!
            # It MUST be awaited from an async context (e.g., in main.py lifespan).
            # DO NOT call setup() here - it will be called from main.py with await.
            
            logger.info("✓ Async PostgreSQL checkpointer initialized (setup() will be called from async context)")
            logger.info("⚠️  Remember to call: await checkpointer.setup() in main.py!")
