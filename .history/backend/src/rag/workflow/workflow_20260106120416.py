...
# Import classify_type_query if exists
try:
    from .graph_nodes.classify_type_query import classify_type_query_node
except ImportError:
    classify_type_query_node = None
...
def build_kg_graph():
    ...
    builder.add_conditional_edges(
        ...
        {
            # "classify_query": "classify_query",  # Commented out - not in ea286d2
            "safety_check": "safety_check",  # Always go to safety_check
        },
    )
    
    # classify_query always goes to safety_check
    # builder.add_edge("classify_query", "safety_check")  # Commented out
