...
# Response template will be loaded lazily
not_mental_health_response = None


async def get_not_mental_health_message() -> str:
    """
    ...
    """
    global not_mental_health_response
    if not_mental_health_response is None:
        try:
