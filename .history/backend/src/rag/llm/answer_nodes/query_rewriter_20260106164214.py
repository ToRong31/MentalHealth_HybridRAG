...
# Rewriter prompt template will be loaded lazily
QUERY_REWRITE_TEMPLATE = None
...
async def rewrite_query_with_slots(
    ...
    global QUERY_REWRITE_TEMPLATE
    if QUERY_REWRITE_TEMPLATE is None:
        try:
            rewriter_prompts = await load_prompts("rewritter_promt.yaml")
