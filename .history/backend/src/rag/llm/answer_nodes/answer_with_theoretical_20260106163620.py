...
system_instructions_theoretical = None
user_template_theoretical = None
...
async def generate_answer_with_theoretical(
    ...
    global system_instructions_theoretical, user_template_theoretical, fallback_answer
    if user_template_theoretical is None:
        try:
            response_templates_theoretical = await load_prompts("answer_with_theoretical.yaml")
