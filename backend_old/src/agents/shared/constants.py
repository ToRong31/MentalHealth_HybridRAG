...
# All domain agents (excluding supervisor)
...
class Priority(str, Enum):
    CRITICAL: Final[str] = "critical"  # Crisis, life-threatening
    HIGH: Final[str] = "high"          # Diagnostic, treatment
    NORMAL: Final[str] = "normal"      # Theory, support
    LOW: Final[str] = "low"            # Background tasks
...
class Intent(str, Enum):
    DIAGNOSTIC: Final[str] = "diagnostic"   # Symptom/disease inquiry
    THEORY: Final[str] = "theory"           # Psychology knowledge
    TREATMENT: Final[str] = "treatment"       # Treatment plan inquiry
    SUPPORT: Final[str] = "support"          # Emotional support (non-disorder)
    CRISIS: Final[str] = "crisis"           # Active crisis detected
...
# Minimum required slots to make a diagnostic attempt
    ...
    def detect(cls, text: str) -> str:
        ...
        for char in text:
            if '\u0041' <= char <= '\u007a' or '\u0030' <= char <= '\u0039':
                continue  # ASCII - could be English
