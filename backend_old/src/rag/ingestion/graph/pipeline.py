...
def create_pipeline(
    ...
    neo4j_uri = neo4j_uri or rag_settings.NEO4J_URI
    neo4j_user = neo4j_user or rag_settings.NEO4J_USER
    neo4j_password = neo4j_password or rag_settings.NEO4J_PASSWORD
