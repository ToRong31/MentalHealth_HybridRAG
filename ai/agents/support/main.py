"""
Support Agent — Standalone FastAPI microservice entry point.
"""
...
from ai.agents.support.schemas import SupportRequest, SupportResponse, HealthResponse
...
async def run_support(req: SupportRequest):
    ...
    try:
        ...
        return SupportResponse(
            ...
            conversation_id=req.conversation_id,
            coping_strategies=result.get("coping_strategies",[]),
        )
    except Exception as e:
